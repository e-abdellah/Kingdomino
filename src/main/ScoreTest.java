...
public class ScoreTest {
	public static void main(String[] args) {
		...
		// Hier vul je het bord 'koninkrijk' met verschillende Vakje objecten
		// Elk Vakje wordt geïnitialiseerd met een Landschapstype en een aantal kronen
		...
		// Hier wordt een ander bord 'koninkrijk1' op dezelfde manier gevuld maar met
		// enkele vakjes als null
		...
		// Aanmaken van Speler objecten met verschillende koninkrijken en initiële
		// waarden
